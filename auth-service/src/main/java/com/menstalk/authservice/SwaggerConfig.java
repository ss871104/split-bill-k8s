package com.menstalk.authservice;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.menstalk.authservice"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Swagger for Auth Service", "RESTFUL API Document for Auth Service", "1.0.0",
