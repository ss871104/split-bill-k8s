package com.menstalk.masterqueryservice;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.menstalk.masterqueryservice"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Swagger for Master Query Service", "RESTFUL API Document for Master Query Service", "1.0.0",
