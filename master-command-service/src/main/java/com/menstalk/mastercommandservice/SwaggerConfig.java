package com.menstalk.mastercommandservice;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.menstalk.mastercommandservice"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Swagger for Master Command Service", "RESTFUL API Document for Master Command Service", "1.0.0",
