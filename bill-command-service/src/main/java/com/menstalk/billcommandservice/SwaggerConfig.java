...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.menstalk.billcommandservice"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Swagger for Bill Command Service", "RESTFUL API Document for Bill Command Service", "1.0.0",
